    ...
    <div class="nav-left">
      <slot name="left">
        ...
        <router-link to="/communities">
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <g
                  ...
                  fill-rule="evenodd"
                >
                  <g id="ic_fluent_people_community_28_filled" fill="#212121" fill-rule="nonzero">
                    <path
          ...
          <Button v-else size="large" class="p-button-outlined communities-btn">
            <svg
              width="16px"
              height="16px"
              viewBox="0 0 28 28"
...
.communities-btn {
  display: flex;
  flex-direction: column; /* Stack SVG on top of text */
  align-items: center; /* Center horizontally */
  justify-content: center; /* Center vertically if needed */
  gap: 0.25rem; /* Space between SVG and text */
}
