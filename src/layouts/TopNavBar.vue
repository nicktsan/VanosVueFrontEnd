    ...
    <div class="nav-right">
      ...
      <router-link to="/create-community">
        <Button
          ...
          label="New Community"
        />
        <Button v-else label="New Community" size="large" class="p-button-outlined nav-btn" />
      </router-link>
...
/* Ensure <router-link> anchors don't add baseline/line-box weirdness */
.nav-left > a,
.nav-right > a {
  display: inline-flex;
  align-items: stretch;
...
/* Unify all button heights across zoom levels */
@media (max-width: 767px) {
  .navbar .nav-btn {
    height: var(--nav-btn-h-mobile);
  }
}
@media (min-width: 768px) {
  .navbar .nav-btn {
    height: var(--nav-btn-h-desktop);
  }
}
